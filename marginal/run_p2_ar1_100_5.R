...
RMSE1.merf=RMSE1.nntanh=RMSE.merf=RMSE.nntanh=RMSE.svmkernel=RMSE.lm=RMSE.lme=RMSE.REEM=RMSE.tree=RMSE.bag=RMSE.rf=RMSE.boost=RMSE.svm=RMSE.nn=matrix(0,sim,3)
...
save.image("data_p2_ar1_100_5.RData")
